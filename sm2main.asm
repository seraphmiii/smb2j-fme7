...
;"INESHDR"
  ...
  .db 2                                         ;  CHR
  .db $53                                       ;  mirroring type and mapper number lower nibble
...
VBlank:
        ...
        lda #$00
        sta FME7Parameter
        lda #FME7_IRQTimer_Ctrl      ;disable IRQs
        sta FME7Command
        lda #$00
        sta FME7Parameter
        jsr SwitchCHRBankAll        ;load SM2CHAR1
...
LoadMainBank:
	  ...
	  jsr SwitchPRGBank0
        lda #MainBank+1
SwitchPRGBank1: 					;This is to save like 3 bytes (why?)
		pha
		lda #$0a
		sta FME7Command
		pla
